...
export default function ConnectScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.bg.base, padding: 24, justifyContent: "center", gap: 16 }}>
      ...
      <Text style={{ color: colors.fg.muted, fontFamily: fonts.body, fontSize: 15, lineHeight: 22 }}>
        Paste the Pair URL generated by your desktop agent.
      </Text>
      <TextInput
        value={code}
      ...
      />
      {error ? (
        <Text style={{ color: colors.status.error, fontFamily: fonts.body, fontSize: 13 }}>
          {error}
        </Text>
      ) : null}
      <Pressable
